...
dict={
        ...
        "2":"Your battery drains much faster when it's hot, even when not in use. Once check the battery capacity of your laptop",
...
for i in num:
    number+=dict.get(i,"")+" "
print(number)
print("Thank You...! I think I had cleared your Doubts")
a = input()